...
if (true) then
{
  _this = createVehicle ["Land_A_CraneCon", [13400.966, 7313.5122, -0.0099999998], [], 0, "CAN_COLLIDE"];
  _vehicle_548 = _this;
  _this setDir -252.41083;
  _this setVehicleInit "this setVectorUp [0,0,1];";
  _this setPos [13400.966, 7313.5122, -0.0099999998];
};

_vehicle_550 = objNull;
if (true) then
{
  _this = createVehicle ["Land_A_CraneCon", [13320.409, 7290.1387, -0.0099999998], [], 0, "CAN_COLLIDE"];
  _vehicle_550 = _this;
  _this setDir -341.93988;
  _this setVehicleInit "this setVectorUp [0,0,1];";
  _this setPos [13320.409, 7290.1387, -0.0099999998];
};
