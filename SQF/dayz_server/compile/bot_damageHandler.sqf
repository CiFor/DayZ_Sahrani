private["_unit","_hit","_damage","_unconscious","_source","_ammo","_type","_isMinor","_isHeadHit","_inVehicle","_isPlayer","_humanityHit","_myKills","_characterID","_player_blood","_method"];
...
if ( _method !="" ) then {
	[_unit,_source,_method] spawn bot_spawnDeath;
} else {
	if (_total > 0.4) then {
