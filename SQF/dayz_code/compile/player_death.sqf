...
if(_playerModel in ["Camo1_DZ","Soldier1_DZ","Rocket_DZ","SMD_RACS_MP","SMD_RACS_MP_Tan","SMD_RACS_MP_TanDigi","SMD_RACS_Soldier","SMD_RACS_SWAT","SMD_SARA_Sheriff","SMD_US_SpecOps"]) then {
