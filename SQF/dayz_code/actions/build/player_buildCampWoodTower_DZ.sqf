...
if (!_isOk) then {
	...
	sleep 5;
	//place tent (local)
	_tent = createVehicle ["CampWoodTower_DZ", _location, [], 0, "CAN_COLLIDE"];
	_tent setdir _dir;
	...
	dayzPublishObj = [dayz_characterID,_tent,[_dir,_location],"CampWoodTower_DZ"];
