...
class Land_A_GeneralStore_01: Supermarket 
	{
		...
		minRoaming = 2;
		maxRoaming = 8;
		zedPos[] = {{13.88,6.66,-2.43},{11.32,8.83,-2.43},{7.45,14.04,-2.43},{3.8,14.33,-2.43},{1.2,13.68,-2.42},{-2.01,15.09,-2.42},{-6.36,14.82,-2.42},{-11.65,11.6,-2.42},{-13.69,8.91,-2.42},{-16.76,6.28,-2.42},{-6.37,-6.9,-1.2},{6.3,-6.8,-1.2}};
	};
