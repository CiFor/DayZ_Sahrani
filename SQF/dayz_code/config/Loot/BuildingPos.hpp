...
class Land_A_GeneralStore_01a: Supermarket 
	{
		...
		lootPos[] = {{-7.66,-1.37,-1.2},{-7.45,-4.19,-1.2},{-5.18,-2.92,-1.2},{-3.17,-4.11,-1.2},{-2.58,-2.92,-1.2},{-0.2,-2.27,-1.2},{2.9,-1.92,-1.2},{6.27,-2.13,-1.2},{7.76,-4.57,-1.2},{7.97,-3.03,-1.2},{9.92,-2.99,-1.2},{10.28,-0.96,-1.2},{13.83,-0.79,-1.2},{12.88,-4.17,-1.2},{6.53,-0.01,-1.2},{2.92,-0.23,-1.2},{-1.71,-0.46,-1.2},{-4.47,1.18,-1.2},{-6.94,3.36,-1.2},{-8.09,5.76,-1.2},{-6.99,8,-1.2},{-4.56,8.42,-1.2},{-2.61,6.7,-1.2},{-3.39,4.06,-1.2},{-2.04,4.31,-1.2},{-1.02,5.57,-1.2},{-3.92,5.42,-1.2},{-7.74,0.58,-1.2},{1.42,5.36,-1.2},{4.47,4.71,-1.2},{6.77,5.48,-1.2},{9.62,5.62,-1.2},{9.38,7.26,-1.2},{6.7,7.63,-1.2},{3.56,8.17,-1.2},{-0.6,8.47,-1.2},{-0.49,2.02,-1.2},{2.28,2.14,-1.2},{5.6,2.61,-1.2},{8.82,2.52,-1.2},{12.14,1.96,-1.2},{15.19,2.98,-1.2},{14.37,5.33,-1.2},{13.78,6.72,-1.2},{13.13,2.96,-1.2}};
		zombieChance = 1;
		minRoaming = 4;
		maxRoaming = 10;
...
class Land_hospital: Hospital //A1 Hospital
	{
		lootChance = 1.00; //    0.15;
		lootPos[] = {{2.02,-4.44,-1.44},{2.97,6.34,-1.44},{-3.74,6.40,-1.44}};
		zombieChance = 1;
		minRoaming = 1;
		maxRoaming = 2;
		zedPos[] = {};
