...
class Land_smd_army_hut3_long_int : MilitarySpecial {
...
class Land_smd_army_hut_storrage : Industrial { //Military
...
class Land_smd_sara_stodola : Farm {
...
class Land_smd_zastavka_jih : Residential {
	maxRoaming = 2;
	lootPos[] = {{1.27,0.27,-1.21}};
};

class Land_smd_zastavka_sever : Residential {
	maxRoaming = 2;
...
class Land_smd_dum_istan3_hromada2 : Residential {
...
//class Land_smd_dum_mesto3_istan : Residential //- Added 01 Oct 2013
class Land_sara_domek_kovarna : Residential {};
class Land_smd_dum02 : Residential {}; //- Updated 01 Oct 2013
class Land_dum_mesto : Residential {};
class Land_dum_mesto2l : Residential {};
//class Land_dum_olezlina : Residential {}; - Updated with Rotated and raised Dum_mesto_in?
class Land_deutshe : Residential {};
class Land_smd_dum_istan2_01 : Residential {};
class Land_smd_dum_istan2_03 : Residential {};
//class Land_smd_dum_istan2_03a : Residential {}; - Added 01 OCt 2013
//class Land_smd_dum_istan2b : Residential {}; - Added 01 OCt 2013
class Land_dum_olez_istan1 : Residential {};
class Land_smd_dum_istan2_04a : Residential {};
...
//class smd_garaz_bez_tanku - added 01 Oct 2013
...
class Land_smd_helfenburk_budova2 : Farm {
	lootPos[] = {{-1.22,-3.58,4.28},{-1.16,2.45,4.36}};
};
class Land_smd_helfenburk : Farm {
...
};////smd_sahrani_a2 additions 30 sep 2013 ///// - Commented out 01 Oct 2013 (changed to smd_)*/
...
class Land_A_CraneCon : Industrial {
	lootPos[] = {{-8.4,0.34,-18.29},{-8.57,0.03,-16.78},{-10.19,0.69,5.79}};
};
class Land_A_GeneralStore_01a : Supermarket {
	lootPos[] = {{-6.93,1.07,-1.2},{-7.3,-2.68,-1.2},{-3.41,-4.39,-1.2},{-1.29,-2.58,-1.2},{1.1,-4.91,-1.15},{2.89,-3.42,-1.2},{6.42,-3.15,-0.36},{13.97,-4.5,-1.2},{10.26,0.11,-1.2},{10.59,-3.84,-1.2},{7.85,-0.14,-1.2},{3.57,0.04,-1.2},{-0.37,5.18,-1.2},{4.78,5.58,-1.2},{13.09,4.36,-1.2},{12.99,6.32,-1.2},{7.36,3.01,-1.2},{1.93,2.17,-1.2},{-4.13,6.5,-0.69},{-7.55,8.54,-1.2},{-4.42,8.97,-1.2},{3.73,8.36,-1.2},{9.84,8.34,-1.2},{-0.1,0.98,-0.52},{7.78,1.04,-0.45},{-8.56,-2.13,0.71}};
};
class Land_A_Hospital : hospital {
	lootPos[] = {{-16.05,-2.46,-7.34},{-12.28,-3.2,-7.34},{4.41,-3.51,-7.34},{16.78,-3.96,-6.89},{-1.13,3.78,-7.45},{12.75,0.14,3.29},{10.27,-1.22,3.29},{0.94,-3.72,-7.34},{-4.47,-3.66,-6.36},{-2.98,-3.31,-7.34},{6.03,-1.01,-7.34}};
};
...
class Land_Ind_IlluminantTower : Industrial {
	lootPos[] = {{-1.3,-0.52,10.43},{1.05,-0.5,10.56}};
};
class Land_rail_station_big : Industrial {
	lootPos[] = {{-4.97,4.56,-4.98},{0.46,4.85,-4.98},{2.13,0.66,-4.04},{-1.32,-2.61,-4.98},{-3.29,-0.12,-4.98},{-1.08,2.37,-4.98},{7.46,-3.42,-4.98},{8.93,3.12,-4.98},{-8.16,-5.13,-4.98}};
};
class Land_repair_center : Industrial {
	lootPos[] = {{-2.76,1.24,-1.53},{-2.7,3.96,-1.53},{0.16,-3.87,-2.53}};
};
class Land_Shed_Ind02 : Industrial {
	lootPos[] = {{-2.28,-5.67,-4.63},{3.91,9.44,-4.63},{4.41,2.65,-1.28},{-0.44,11.69,-1.28},{-3.44,12.21,-1.28},{-5.56,1.04,-4.08},{-0.54,-9.24,-4.63},{1.95,-0.56,-4.63},{-3.75,-6.68,-1.29},{-4.14,-1.32,-1.29}};
};
class Land_smd_ammostore2_open : MilitarySpecial {
	lootPos[] = {{1.96,0.92,-2.44},{-1.34,4.8,-2.03},{-2,0.98,-2.44},{1.73,0.13,3.4},{1.19,4.44,3.4}};
};
class Land_smd_bouda_plech_open : Industrial { ////Trollshed
	lootPos[] = {{0.18,1.5,-1.04},{0.35,-1.33,-0.96}};
};
class Land_smd_budova4_in : Military { ////A1 Barracks With animated doors Need Glass
	lootPos[] = {{6.38,-2.44,-1.89},{0.44,-2.29,-1.52},{4.03,-2.27,-1.53},{-1.55,-2.73,-1.89},{-1.61,-2.71,-0.91},{-6.98,-0.17,-1.89},{-3.97,-2.53,-1.89},{-5.75,2.03,-1.89},{-0.79,2.11,-1.89}};
};
class Land_smd_dum_mesto_in_open :  Residential {
	lootPos[] = {{-4.38,-3.12,-3.36},{-4.5,4.61,-3.26},{-1.18,4.14,-3.36},{3.51,-3.27,-2.22},{5.56,2.93,-3.36},{3.2,2.35,-3.36},{5.55,3.46,-0.37},{3.14,-2.75,-0.37},{-5,-3.43,-0.37},{-3.19,3.19,-0.37}}; 
};
class Land_smd_dum_olez_istan1_open : Residential {
	lootPos[] = {{-2.08,-4.53,-1.84},{-6.28,1.06,-1.84},{5.86,2.26,-1.48},{6.95,1.61,-1.84},{5.74,-1.63,1.89},{5.25,-3.29,1.37},{-1.88,-4.96,1.37},{-6.18,1.35,1.37}};
};
class Land_smd_dum_olez_istan1_open2 : Residential {
	lootPos[] = {{-2.08,-4.53,-1.84},{-6.28,1.06,-1.84},{5.86,2.26,-1.48},{6.95,1.61,-1.84},{5.74,-1.63,1.89},{5.25,-3.29,1.37},{-1.88,-4.96,1.37},{-6.18,1.35,1.37}};
};
class Land_smd_dum_olez_istan2_open : Residential {
	lootPos[] = {{-0.53,4.69,-0.37},{2.88,1.48,-0.37},{0.42,-4.87,0.34},{-4.03,2.34,-0.37},{4.85,-0.22,-0.38}};
};
class Land_smd_dum_olez_istan2_open2 : Residential {
	lootPos[] = {{-0.53,4.69,-0.37},{2.88,1.48,-0.37},{0.42,-4.87,0.34},{-4.03,2.34,-0.37},{4.85,-0.22,-0.38}};
};
class Land_smd_dum_olezlina_open : Residential {
	lootPos[] = {{-7.16,3.35,-3.83},{-6.44,-3.22,-3.83},{2.3,-2.14,-3.83},{7.01,1.03,-3.83},{6.6,-1.67,-3.1},{-2.18,-2.75,-0.44},{-6.54,-3,-0.43},{-6.47,1.47,-0.43},{7.43,-2.93,0.24},{2.14,-2.12,-0.43},{6.25,2.29,-0.43}};
};
class Land_smd_fuelstation_army : Industrial {
	lootPos[] = {{1.57,-0.24,-0.1},{-1.75,1.3,-2.29},{1.51,4.06,-2.29}}; 
};
class Land_smd_garaz_bez_tanku : Military {
	lootPos[] = {{-4.51,-3.32,-2.6},{-0.06,-5.33,-0.57},{6.21,-0.06,3.42},{-5.33,-0.07,3.42},{-0.07,3.96,3.42}};
};
class Land_smd_garaz_mala_open : Industrial {
	lootPos[] = {{-0.75,-1.86,-1.14},{1.23,1.22,-1.14}};
};
class Land_smd_garaz_s_tankem : Military {
	lootPos[] = {{3.8,1.26,-2.49},{-6.83,3.86,-2.49},{-6.9,0.47,-1.68},{-5.49,0.87,3.47},{2.06,0.75,3.47},{5.25,3.98,3.47}};
};
class Land_smd_hospoda_mesto : Residential {
	lootPos[] = {{4.49,-1.74,-4.22},{6.89,0.23,-5.19},{3.22,0.96,-5.19},{6.26,6.91,-4.36},{3.73,7.16,-5.19},{2.27,-1.12,-5.18},{-0.74,-5.57,-5.17},{-5.88,-2.86,-5.17},{-5.57,-4.42,-1.23},{4.68,1,0.72},{4.28,-3.7,-1.25},{5.38,-4.91,-1.25},{5.15,7.11,-0.59},{4.85,7.02,-1.25},{3.27,2.24,-1.25}};
};
...
class Land_smd_kasarna_prujezd : Residential { ////Yellow Block Apts with Archway
	lootPos[] = {{-0.91,-3.73,-8.74},{0.88,0.96,-8.74},{-1.32,4.36,-8.74}};
};
class Land_smd_kostel_mexico : Residential {
	lootPos[] = {{-4.6,-7.02,-2.79},{-5.55,-4.76,-2.79},{-6.84,-5.13,-9.21},{6.67,-5.67,-9.21},{4.41,-7.14,-2.74},{6.72,-4.83,-2.72}};
};
class Land_smd_kostel_trosky : Residential {
	lootPos[] = {{-3.13,-11.97,-5.32},{1.96,-6.38,-5.32},{1.06,-1.11,-5.32},{-1.86,2.92,-5.32},{0.21,11.96,-5.32},{8.1,1.17,-5.33},{5.7,13.69,-5.33}};
};
class Land_smd_letistni_hala : Military { ////Airport Terminal
	lootPos[] = {{1.22,-6.46,-8.27},{4.9,-6.37,-8.27},{2.97,4.32,-8.27},{-7.63,2.94,-1.85},{8.4,-2,-1.83},{-0.01,-2.55,0.75},{5.95,-2.82,0.75}};
};
class Land_smd_majak_v_celku : Industrial { ////lighthouse
	lootPos[] = {{1.82,-1.69,-6.09},{0.2,-5.03,-6.07},{0.15,-7.09,3.73},{1.98,-8.13,-6.09}};
};
class Land_smd_Panelak : Residential {
	lootPos[] = {{0.51,0.49,-1.22},{-6.7,3.69,0.07},{-6.26,-0.44,0.07},{-5.32,-4.38,0.44},{-5.67,-6.62,0.07},{-3.49,-5.4,0.07},{-0.53,4.35,1.37},{0.84,-3.78,2.77},{4.95,2.57,2.77},{6.18,-0.24,2.77},{5.27,-4.61,3.09}};
};
class Land_smd_shop1_double : Residential {
	lootPos[] = {{-1.45,-1.04,-2.02}};
};
class Land_smd_shop2 : Residential { 
	lootPos[] = {{-0.81,-1.79,-2.02}}; 
};
class Land_smd_shop2_double : Residential { 
	lootPos[] = {{-0.21,-1.93,-2.02}};
};
class Land_smd_shop3 : Residential { 
	lootPos[] = {{0.51,-2.3,-2.02}};
};
class Land_smd_shop5 : Residential { 
	lootPos[] = {{-1.44,-1.38,-2.02}};
};
...
class Land_Vysilac_FM : Industrial {
	lootPos[] = {{2.13,-0.48,8.39},{0.55,-1.17,8.39}};
};
class datsun01Wreck : Residential {
	lootPos[] = {{0,0.18,-0.75},{-0.1,-0.51,-0.16}};
};
class UralWreck : Industrial {
	lootPos[] = {{-0.17,-0.67,-1.19}};
};
...
/*class Land_smd_budova4_in: Military {
	maxRoaming = 3;
