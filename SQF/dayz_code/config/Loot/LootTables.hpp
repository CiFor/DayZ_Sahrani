...
//Crash3C130_UnArmed
	...
	class Farm: Default {
		zombieChance = 1;
		maxRoaming = 3;
		zombieClass[] = {"z_villager1","z_villager2","z_villager3","z_worker2"};
		lootChance = 1;
		lootPos[] = {};
		itemType[] =	{
			{"DZ_ALICE_Pack_EP1","object"},
		...
		itemChance[] =	{
			...
			0, //WeaponHolder_ItemBaseball_Bat","object
			0.2, //WeaponHolder_ItemCrowbar","object
			0.4, //WeaponHolder_ItemHatchet","object
			0, //WeaponHolder_ItemMachete","object
			0 //WeaponHolder_ItemShovel","object
		};
	};
	...
	class Hunting: Default {
		...
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"z_villager1","z_villager2"};
		lootChance = 1;
		lootPos[] = {};
		itemType[] =	{
			{"ItemMap","weapon"},
	...
	class Church: Residential {
		minRoaming = 1;
		maxRoaming = 3;
		zombieClass[] = {"z_priest","z_suit1","z_suit2","z_villager1","z_villager2"};
	};
