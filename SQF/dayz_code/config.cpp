...
class CfgBuildingLoot {
	...
	class Military : Default {
		...
		itemChance[] = {0.05, 0.05, 0.01, 0.02, 0.2, 0.15, 0.01, 0.08, 0.05, 0.05, 0.01, 0.1, 0.01, 0.02, 0.01, 0.05, 0.08, 0.1, 0.04, 0.02, 0.01, 0.06, 0.1, 0.1, 0.01, 0.05, 0.06, 0.04, 0.02, 0.1, 1, 2.5, 0.05, 0.02};
	};
	...
	class MilitarySpecial : Default {
		...
		itemChance[] = {0.1, 0.05, 0.01, 0.02, 0.01, 0.2, 0.1, 0.02, 0.1, 0.1, 0.1, 0.01, 0.01, 0.2, 0.01, 0.02, 0.1, 0.03, 0.2, 0.1, 0.2, 0.01, 0.04, 0.05, 0.02, 0.01, 0.08, 0.04, 0.02, 0.01, 0.1, 0.05, 0.15, 0.01, 0.03, 0.01, 0.02, 0.03, 0.02, 0.3, 1, 5, 0.01};
	};
	...
	class Land_hlaska : Military {
		maxRoaming = 2;
		lootPos[] = {0.00585938, -0.78273, 3.25368};
	};
	...
	class Land_stodola_open : Farm {
		maxRoaming = 3;
		lootPos[] = {{1.08398, -4.4668, -3.71598}, {-1.29297, 4221289, -3.85822}};
	};
	
	class Land_sara_stodola2 : Farm {
		maxRoaming = 3;
		lootPos[] = {{-2.00781, -0.365234, -2.14878}, {3.67969, 1.01953, -2.16878}};
	};
	
	class Land_helfenburk_budova2 : Farm {
		maxRoaming = 3;
		lootPos[] = {-1.23145, -2.87988, 4.27978};
	};
	
	class Land_helfenburk : Farm {
		maxRoaming =  3;
		lootPos[] = {{1.87109, 1.08301, -3.01715}, {0.253906, 0.675293, 0.272316}, {0.0449219, 0.320313, 4.35992}, {-1.47656, -4.78076, 4.35992}, {-2.34766, -2.39014, 8.70477}, {1.25, -0.392578, 12.1881}, {-0.322266, -5.07471, 12.1881}};
	};
	...
	class Land_budova4_in : Military {
		maxRoaming = 3;
		lootPos[] = {{ -5.85156,2.12891,-1.88723 }, { 6.10449,2.15771,-1.88723 }, { 3.0791,2.55444,-1.88723 }, { 0.847656,2.54126,-1.88723 }, { 5.7041,-1.94287,-1.88723 }};
	};
	...
	class Land_vez : Military {
		maxRoaming = 2;
		lootPos[] = {0.0385742, 1.35742, 1.36331};
	};
	...
	class Land_sara_hasic_zbroj : Industrial {
		maxRoaming = 2;
		lootPos[] = {{0.0, 0.0, -2.64}, {3.5, 1.0, -2.64}};
	};
	...
	class Land_Panelak3 : Office {
		maxRoaming = 3;
		lootPos[] = {{2.87891, -4.78906, 12.3769}, {5.47754, 1.60449, 12.3769}, {-3.91797, 0.867188, 12.3769}, {-6.34814, -4.48438, 12.3769}};
	};
	
	class Land_afdum_mesto3 : Office {
		maxRoaming = 3;
		lootPos[] = {};
	};
	
	class Land_dum_istan4 : Office {
		maxRoaming = 5;
		lootPos[] = {{ 2.87451,-2.34131,-4.34236 }, { 5.75244,5.91211,-7.29237 }, { 2.45313,-7.61938,-5.9352 }};
	};
	
	class Land_dum_istan4_inverse : Office {
		maxRoaming = 5;
		lootPos[] = {{ -2.82471,-2.41382,-4.33588 }};
	};
	...
	class Land_cihlovej_dum_mini : Residential {
		maxRoaming = 3;
		lootPos[] = {{1.97754, 0.788086, -2.86942}, {-1.87793, 1.84766, -2.86942}};
	};
	
	class Land_dum_istan4_detaily1 : Residential {
		maxRoaming = 3;
		lootPos[] = {{ -5.30811, 5.30078, -7.28588 }};
	};
	...
	class Land_dum_istan2_02 : Office {
		maxRoaming = 4;
		lootPos[] = {{ -1.33203, 1.71924, -4.21303}, { -0.924805, -2.03711, -4.21303}};
	};
