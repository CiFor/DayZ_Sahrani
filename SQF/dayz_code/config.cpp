...
class CfgBuildingLoot {
	...
	class Farm: Default {
		...
		itemChance[] =	{
			//backpacks
			0.8, //DZ_ALICE_Pack_EP1","object
			0.4, //DZ_Assault_Pack_EP1","object
			0.2, //DZ_British_ACU","object
			0.6, //DZ_Czech_Vest_Puch","object
			0.8, //DZ_TK_Assault_Pack_EP1","object
			//classloottypes
			0.5, //"","farm
			0.2, //"","food
			0.3, //"","hunter
			...
			//inventorytrash
			//inventoryvehicleparts
			0.1, //WeaponHolder_ItemJerrycan","object"},
			0.1, //WeaponHolder_PartEngine","object"},
			0.1, //WeaponHolder_PartFueltank","object"},
			0.4, //WeaponHolder_PartGeneric","object"},
			0.4, //WeaponHolder_PartWheel","object"}
			//primaryweapons
			0.1, //Crossbow_DZ","weapon
			0.4, //huntingrifle","weapon
			0.8, //LeeEnfield","weapon
			0.1, //MR43","weapon
			0.4, //Winchester1866","weapon
			//secondaryweapons
			0.4, //Colt1911","weapon
			0.8, //Makarov","weapon
			0.01, //MakarovSD","weapon
			0.4, //revolver_EP1","weapon
			//toolbeltcraftingbooks
			0.4, //ItemCraftingBook","weapon
			0.4, //ItemCraftingBook2","weapon"},
			//toolbeltONLYitems
			0.2, //ItemCompass","generic
			0.2, //ItemKnife","generic
			0.1, //ItemMap","weapon
			0.5, //ItemMatchbox","generic
			0.8, //ItemToolbox","weapon"},
			0.2, //ItemWatch","generic
			//toolbeltSwitchableweapons
			0.9, //WeaponHolder_ItemHatchet","object
			0.5 //WeaponHolder_ItemMachete","object
		};
	};
	class Supermarket: Default {
		...
		itemChance[] =	{
			...
			0.6, //DZ_Assault_Pack_EP1
			0.1, //DZ_British_ACU
			0.8, //DZ_Czech_Vest_Puch
			0.3, //DZ_TK_Assault_Pack_EP1
			//class loot types
			2, //"","food
			0.3, //"","medical
			2, //"","trash
	...
	class Military: Default {
		...
		itemChance[] =	{
			...
			//primary weapons, 			
 			...
 			0, //RPK_74",weapon
 			0.3, //Sa58P_EP1",weapon
 			0.3, //Sa58V_CCO_EP1",weapon
 			0.5, //Sa58V_EP1",weapon
 			0, //Sa58V_RCO_EP1",weapon
 			0.5, //SCAR_L_CQC",weapon
			...
			//secondary weapons, 			
 			...
 			0.01, //UZI_SD_EP1
			//toolbelt crafting books, 			
 			0.1, //ItemCraftingBook","weapon
 			0.2, //ItemCraftingBook2","weapon
 			0.4 			//ItemCraftingBook3","weapon
			//toolbelt ONLY items, 			
			//toolbelt Switchable weapons, 
		};
	};
	class MilitarySpecial: Default {
		...
		itemChance[] =	{
			...
			0, //DZ_ALICE_Pack_EP1","object
			0, //DZ_Assault_Pack_EP1","object
			0.4, //DZ_Backpack_EP1","object
			0.6, //DZ_British_ACU","object
			0.4, //DZ_CivilBackpack_EP1","object
			0, //DZ_Czech_Vest_Puch","object
			0, //DZ_TK_Assault_Pack_EP1","object
			//class loot types
			0.3, //"","hospital
			...
			0.2, //AK_107_GL_pso","{weapon
			0.2, //AK_74_GL_kobra","{weapon
			0.2, //AKS_74_NSPU","{weapon
			0.2, //AKS_74_pso","{weapon
			0.2, //AKS_74_UN_kobra","{weapon
			0.2, //BAF_AS50_scoped","{weapon
			0.2, //BAF_GMG","{weapon
			0.2, //BAF_L110A1","{weapon
			0.2, //BAF_L110A1_Aim","{weapon
			0.2, //BAF_L2A1","{weapon
			0.2, //BAF_L7A2","{weapon
			0.2, //BAF_L7A2_GPMG","{weapon
			0.2, //BAF_L85A2_RIS_ACOG","{weapon
			0.2, //BAF_L85A2_RIS_CWS","{weapon
			0.2, //BAF_L85A2_RIS_Holo","{weapon
			0.2, //BAF_L85A2_RIS_SUSAT","{weapon
			0.2, //BAF_L85A2_UGL_ACOG","{weapon
			0.2, //BAF_L85A2_UGL_Holo","{weapon
			0.2, //BAF_L85A2_UGL_SUSAT","{weapon
			0.2, //BAF_L86A2_ACOG","{weapon
			0.2, //BAF_L94A1","{weapon
			0.2, //BAF_LRR_scoped","{weapon
			0.2, //BAF_LRR_scoped_W","{weapon
			0.2, //bizon_silenced","{weapon
			0.2, //DMR","{weapon
			0.2, //FN_FAL_ANPVS4","{weapon
			0.2, //G36_C_SD_camo","{weapon
			0.2, //G36_C_SD_eotech","{weapon
			0.2, //G36a","{weapon
			0.2, //G36A_camo","{weapon
			0.2, //ksvk_DZ","{weapon
			0.2, //M107_DZ","{weapon
			0.2, //m16a4_acg","{weapon
			0.2, //M16A4_ACG_GL","{weapon
			0.2, //m240_scoped_EP1","{weapon
			0.2, //M32_EP1","{weapon
			0.2, //M40A3","{weapon
			0.2, //M4A1_AIM_SD_camo","{weapon
			0.2, //M4A1_HWS_GL_SD_Camo","{weapon
			0.2, //M4A3_RCO_GL_EP1","{weapon
			0.2, //M4SPR","{weapon
			0.2, //M60A4_EP1","{weapon
			0.2, //M79_EP1","{weapon
			0.2, //m8_holo_sd","{weapon
			0.2, //m8_sharpshooter","{weapon
			0.2, //MK_12","{weapon
			0.2, //Mk13_EP1","{weapon
			0.2, //MP5SD","{weapon
			0.2, //Pecheneg","{weapon
			...
			0.2, //RPK_74","{weapon
			0.2, //Sa58V_RCO_EP1","{weapon
			0.2, //SCAR_H_LNG_Sniper","{weapon
			0.2, //SCAR_H_LNG_Sniper_SD","{weapon
			0.2, //SCAR_L_CQC_EGLM_Holo","{weapon
			0.2, //SCAR_L_STD_EGLM_RCO","{weapon
			0.2, //SCAR_L_STD_Mk4CQT","{weapon
			0.2, //SVD_CAMO","{weapon
			0.2, //SVD_des_EP1","{weapon
			0.2, //VSS_vintorez","{weapon
			//secondary weapons
			0, //Colt1911
			0, //glock17_EP1
			0, //M9
	...
	class Land_vez : MilitarySpecial {
		lootChance = 1;
