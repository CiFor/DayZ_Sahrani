...
class CfgMarkers {
	...
	class Flag: Empty {};
	class Flag1: Empty {};
	//class Dot: Empty {}; //Needed for spawn testing
	class Destroy: Empty {};
	class Start: Empty {};
	class End: Empty {};
	class Warning: Empty {};
