...
//Class smd_sahrani_a2 : config.bin{
 class smd_sahrani_A2
 {
  units[] = {"smd_sahrani_A2"};
  weapons[] = {};
  requiredVersion = 0.1;
  requiredAddons[] = {"smd_sahrani_artif_obj","smd_sahrani_rocks","smd_sahrani_veg","smd_roads"};
  author[] = {"SMD"};
  version = "0.55";
 };
...
class CfgWorlds
{
 ...
 class CAWorld: DefaultWorld
 {
  ...
  class Weather: Weather
  {
   ...
   class Overcast: Overcast
   {
    ...
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_clear_sky.paa";
     horizon = "";
    };
    class Weather7: Weather1
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_veryclear_sky.paa";
     horizon = "";
    };
    class Weather2: Weather2
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_almostclear_sky.paa";
     horizon = "";
    };
    class Weather3: Weather3
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_semicloudy_sky.paa";
     horizon = "";
    };
    class Weather4: Weather4
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_cloudy_sky.paa";
     horizon = "";
    };
    class Weather5: Weather5
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_mostlycloudy_sky.paa";
     horizon = "";
    };
    class Weather6: Weather5
    {
     sky = "smd_sahrani_artif_obj\skybox\sky_overcast_sky.paa";
     horizon = "";
    };
   };
  };
 ...
 class smd_sahrani_A2: CAWorld
 {
  ...
  access = 3;
  cutscenes[] = {SMD_Sahrani_A2_Intro1};
  description = "Sahrani";
  icon = "";
  worldName = "SMD\SMD_Sahrani_A2\smd_sahrani_a2.wrp";
  pictureMap = "";
  pictureShot = "SMD\SMD_Sahrani_A2\Data\smd_sara_a2_menu_ca.paa";
  plateFormat = "ML$ - #####";
...
class CfgSurfaceCharacters
{
 ...
 {
  probability[] = {0.5,0.05,0.3,0.001,0.002,0.001,0.05,0.01,0.001,0.001};
  names[] = {"Sara_A2_GrassAutumnLong","Sara_A2_GrassAutumnBrownS","Sara_A2_GrassCrookedForest","Sara_A2_GrassTall","Sara_A2_SmallLeafPlant","Sara_A2_Weed3Small","Sara_A2_BlueBerry","Sara_A2_WeedSedge","Sara_A2_Weed3","Sara_A2_MushroomsHorcak"};
 };
 class Sara_A2_grass2Clutter
 {
  probability[] = {0.5,0.05,0.15,0.1,0.002,0.001,0.05,0.01};
  names[] = {"Sara_A2_GrassAutumnLong","Sara_A2_GrassAutumnBrownS","Sara_A2_GrassCrookedForest","Sara_A2_GrassTall","Sara_A2_SmallLeafPlant","Sara_A2_Weed3Small","Sara_A2_BlueBerry","Sara_A2_WeedSedge"};
 };
 class Sara_A2_forrestClutter
 {
  probability[] = {0.45,0.04,0.15,0.25,0.001,0.001,0.001,0.001,0.1,0.005};
  names[] = {"Sara_A2_GrassAutumnLong","Sara_A2_GrassAutumnBrownS","Sara_A2_GrassCrookedForest","Sara_A2_GrassTall","Sara_A2_SmallLeafPlant","Sara_A2_Weed3","Sara_A2_SmallPicea","Sara_A2_Fern","Sara_A2_GrassBunch","Sara_A2_c_stubble"};
 };
